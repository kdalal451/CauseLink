          ...
          <div className="bg-purple-200_87 flex flex-col gap-[49px] items-start justify-start max-w-[1275px] mx-auto p-9 md:px-5 w-full">
            ...
            <div className="flex flex-col md:ml-[0] ml-[11px] relative w-[98%] md:w-full">
              <div className="md:h-[183px] h-[218px] mx-auto w-full">
                <div className="absolute bg-gray-300 border-2 border-gray-900 border-solid flex flex-col inset-x-[0] items-start justify-start mx-auto p-[21px] sm:px-5 rounded-[15px] top-[0] w-full">
                  <Text
                    className="mb-[103px] ml-3 md:ml-[0] md:text-3xl sm:text-[28px] text-[32px] text-gray-900"
                    size="txtJudsonBold32Gray900"
                  >
                    New English Brewing - San Diego Brewery
                  </Text>
                </div>
                <Text
                ...
                >
                  <>
                    ...
                    <br />
                    San Diego, California 92121-1322
                  </>
                </Text>
              </div>
              <Button
                className="common-pointer border-2 border-black-900 border-solid cursor-pointer leading-[normal] min-w-[129px] ml-[168px] mt-[-0.05px] rounded-lg sm:text-[25px] md:text-[27px] text-[29px] text-center z-[1]"
              ...
              <Button
                className="common-pointer border-2 border-gray-900 border-solid cursor-pointer leading-[normal] min-w-[129px] ml-2.5 mt-[-0.05px] rounded-lg sm:text-[25px] md:text-[27px] text-[29px] text-center z-[1]"
                onClick={() => navigate("/registerfour")}
                shape="round"
                color="gray_300"
                size="xs"
                variant="fill"

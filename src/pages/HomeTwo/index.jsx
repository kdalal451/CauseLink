    ...
    <>
      <div className="bg-gray-900 flex flex-col font-judson items-center justify-start mx-auto pb-[86px] w-full">
        <div className="bg-gray-600 flex sm:flex-col flex-row sm:gap-5 items-start justify-start md:pr-10 sm:pr-5 pr-[78px] w-full">
          ...
          />
          <Text
            className="sm:ml-[0] ml-[43px] sm:mt-0 mt-[71px] text-3xl sm:text-[26px] md:text-[28px] text-white-A700"
        ...
        <div className="flex flex-col items-end mt-[25px] md:px-10 sm:px-5 px-[127px] w-full">
          <div className="bg-blue_gray-100 flex flex-col items-center justify-start md:px-5 rounded-[19px] w-[8%] md:w-full">
            <Switch
              onColor="#291539"
              offColor="#291539"
        ...
        <div className="flex flex-col items-center justify-start max-w-[1346px] mt-[58px] mx-auto md:px-5 shadow-bs2 w-full">
          <div className="bg-purple-200 flex flex-col items-end justify-start md:pl-10 sm:pl-5 pl-[129px] w-full">
            <div className="flex md:flex-col flex-row gap-[49px] items-start justify-end w-full">
              ...
              <Img
                className="md:flex-1 h-[545px] sm:h-auto object-cover w-[49%] md:w-full"
        ...
        <div className="flex flex-col items-center justify-start max-w-[1346px] mt-[129px] mx-auto md:px-5 w-full">
          <div className="flex flex-col gap-[59px] items-center justify-start w-full">
            ...
            <div className="flex sm:flex-col flex-row md:gap-10 items-start justify-between w-full">
              ...
              >
                Points of Light Engage pulls volunteer opportunities from sites
              ...
              <Img
                className="h-[394px] md:h-auto object-cover rounded-[50px]"
